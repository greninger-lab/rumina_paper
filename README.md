...
10.5281/zenodo.18176786   
10.5281/zenodo.18176727   
10.5281/zenodo.18167532   
10.5281/zenodo.18167541   
10.5281/zenodo.18167357   
10.5281/zenodo.18167425   
10.5281/zenodo.18167579   
10.5281/zenodo.18167489   
...
All files relating to this section are hosted in this repository.
...
###### Input BAMs generated from the FASTQ processing steps are located in these DOIs:
...
DOI 10.5281/zenodo.18167489 contains copies of the fastq processing and reproducibility calculation scripts  mentioned before. files ending with `_cluster_report.tsv` are cluster grouping reports generated with the `tag_splitter` program.

DOI 10.5281/zenodo.18167532 contains the first of the output files generated by each tool: the output files are grouped in gzipped tarballs, with each archive belonging to a tool-method-singletons-thread combination. 

DOIs 10.5281/zenodo.18167541 and 10.5281/zenodo.18176727 contain the remainder the output tarballs. In addition, cluster reports generated on the ouptut bams with the `tag_splitter` program to investigate UMI clustering patterns are found in `cluster_reports.tar.gz`
...
All files for this section can be found at DOI 10.5281/zenodo.18167579.
...
All files for this section can be found in DOI 10.5281/zenodo.18176786.
